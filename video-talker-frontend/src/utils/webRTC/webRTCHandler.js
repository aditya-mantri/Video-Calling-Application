...
export const handlePreOfferAnswer = (data) => {
  ...
  if (data.answer === preOfferAnswers.CALL_ACCEPTED) {
    ...
    if (data.answer === preOfferAnswers.CALL_NOT_AVAILABLE) {
      rejectionReason = 'Callee is unable to pick your call at this time, Try again later.';
    } else {
      rejectionReason = 'Oops! Your Call has been rejected by the Callee.';
    }
...
export const sendMessageUsingDataChannel = (message) => {
  ...
  store.dispatch(setMessage(false, message ));
};
